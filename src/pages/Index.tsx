          ...
          <div className="container px-6 mx-auto">
            <div className="max-w-4xl mx-auto text-center mb-12">
              <h2 className="text-2xl md:text-3xl font-display font-bold mb-4">
                How CollegeMate Works
              </h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Buy and sell items within your campus community in three simple steps.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: 'Take a photo, set a price, and post your listing in less than 60 seconds.',
                },
                {
                  icon: <Heart className="h-8 w-8 text-primary" />,
                  title: 'Connect & Chat',
                  description: 'Get notified when someone is interested and chat securely within the app.',
                },
                {
                  icon: <Shield className="h-8 w-8 text-primary" />,
                  title: 'Meet & Exchange',
                  description: 'Arrange a safe campus meetup to exchange items and payment.',
                }
              ].map((step, i) => (
        ...
        <section className="py-20 bg-gradient-to-r from-primary/10 to-primary/5">
          <div className="container px-6 mx-auto">
            <div className="glass rounded-3xl p-8 md:p-12 text-center">
              <h2 className="text-2xl md:text-3xl font-display font-bold mb-4">
                Ready to Buy and Sell on Campus?
              </h2>
              <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
                Join thousands of students already using CollegeMate to buy and sell items on campus.
              </p>
